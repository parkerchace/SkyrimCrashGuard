...
std::string LogInjector::CreateWarningHeader() {
    ...
    return fmt::format(
        ...
        "\n"
        "CrashGuard attempted to recover this crash via its 7-layer VEH chain before\n"
        "CrashLogger received it. All recovery layers (L1, L1b, L2, L3, L4, L5, L6)\n"
        "were exhausted. CrashGuard may have modified game state during those attempts.\n"
        "\n"
